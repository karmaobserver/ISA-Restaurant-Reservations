...
public class KorisnikDaoBean extends GenericDaoBean<Korisnik, Integer> implements KorisnikDaoLocal{
	...
	@Override
	public Korisnik findKorisnikSaKorisnickimImenomILozinkom(String korisnickoIme, String lozinka) {
		Query q = em.createNamedQuery("findKorisnikSaKorisnickimImenomILozinkom");
		q.setParameter("korisnickoIme", korisnickoIme);
		q.setParameter("lozinka", lozinka);
		Korisnik rezultat = (Korisnik) q.getSingleResult();
